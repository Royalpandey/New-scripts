...
echo "${YELLOW_TEXT}${BOLD_TEXT}✏️  Updating Python runtime in app.yaml to python313 for '1-HelloWorld'...${RESET_FORMAT}"
...
echo "${YELLOW_TEXT}${BOLD_TEXT}✏️  Updating Python runtime in app.yaml for '2-HelloUser' to python313...${RESET_FORMAT}"
sed -i 's/python37/python313/g' app.yaml
echo
...
echo "${YELLOW_TEXT}${BOLD_TEXT}✏️  Updating Python runtime in app.yaml for '3-HelloVerifiedUser' to python313...${RESET_FORMAT}"
sed -i 's/python37/python313/g' app.yaml
echo
